...
public class LocationBeanDto implements Serializable {
	...
	public LocationBeanDto() {
	}

	public LocationBeanDto(String user, String latitude, String longitude, String time) {
		super();
		this.user = user;
